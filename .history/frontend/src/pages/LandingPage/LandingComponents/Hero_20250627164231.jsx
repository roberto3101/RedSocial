        ...
        <div className="hero-visual">
          <div className="visual-container">
            ...
            <div className="profile-mockup">
              ...
              <div className="profile-header">
                <div className="level-badge">
                  ...
                  <span className="level-number">42</span>
                </div>
              ...
              <div className="profile-content">
                <div className="avatar-container">
                  <div className="avatar-frame">
                    <img 
                      src="https://api.dicebear.com/7.x/avataaars/svg?seed=Warrior" 
                      alt="Avatar"
                  ...
                  <div className="profile-info">
                    <h3 className="profile-name">Ragnar DevMaster</h3>
            ...
            <div className="floating-element elem-1">
              ...
              <span>Invocación de aliado</span>
            </div>
...
/* --- Mejor ubicación para floating-element: sólo decorativos en esquinas, nunca cruzan contenido --- */
...
/* No tapar ni ser clickeables nunca */
.floating-element {
  z-index: 1 !important;
  opacity: 0.66 !important;
  filter: blur(0.3px);
  pointer-events: none !important; /* Totalmente decorativo */
  max-width: 200px;
}
