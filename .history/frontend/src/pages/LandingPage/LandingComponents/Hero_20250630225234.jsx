...
export default function Hero() {
  ...
  return (
    <section className="hero-section">
      ...
      {/* Navegación épica CON HAMBURGUESA - NUEVAS CLASES */}
      <nav className="hero-nav">
        <div className="hero-nav-container">
          <div className="hero-logo">
            <div className="hero-logo-rune">⚔</div>
          ...
          <div className={`hero-nav-links ${isMenuOpen ? 'hero-mobile-open' : ''}`}>
            <a href="#features" className="hero-nav-link" onClick={closeMenu}>
              <span className="hero-link-rune">◈</span>
              Poderes
            </a>
            <a href="#profiles" className="hero-nav-link" onClick={closeMenu}>
              <span className="hero-link-rune">◈</span>
              Héroes
            </a>
            <a href="#quests" className="hero-nav-link" onClick={closeMenu}>
              <span className="hero-link-rune">◈</span>
              Misiones
            </a>
            <Link to="/login" className="hero-nav-link hero-nav-link-login" onClick={closeMenu}>
              <span className="hero-link-rune">⚡</span>
              Portal
            </Link>
            <Link to="/register" className="hero-nav-cta" onClick={closeMenu}>
              <span className="cta-icon">🔥</span>
              <span>Unirse al Reino</span>
              <div className="hero-cta-aura"></div>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <div className="hero-content">
        <div className="hero-text">
          <div className="hero-badge">
            ...
            <span>Reino de Desarrolladores en LATAM</span>
          </div>
        ...
        {/* Visual épico de perfil - CLICKEABLE */}
      ...
      {/* Overlay para cerrar menú en móvil - NUEVA CLASE */}
      {isMenuOpen && <div className="hero-menu-overlay" onClick={closeMenu}></div>}
    </section>
  );
}